				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<?php echo form_open_multipart('','id="add_form"'); ?>
							...
							<?php 
								...
								echo form_input(
									array(
										...
										'id'    => 'kategorie_nazwa',
										'value' => $dane_kategorii["kategorie_nazwa"],
										'class' => 'form-control'
									)
								); 
							?>
							...
							<?php 
								echo form_label('Plik graficzny rzeczy:', 'kategorie_plikGraficzny');
								echo form_upload(
									array(
										'name'  => 'kategorie_plikGraficzny',
										'id'    => 'kategorie_plikGraficzny',
										'value' => $dane_kategorii["kategorie_plikGraficzny"],
										'class' => ''
									)
								); 
							?>
							...
							<div>
								<div class="obrazek">
									<img id="zdjecie" src="<?php echo $this->config->base_url(); ?>kategorie/<?php echo $dane_kategorii["kategorie_plikGraficzny"]; ?>" alt="your image" />
								</div>
							</div>
							</div>
