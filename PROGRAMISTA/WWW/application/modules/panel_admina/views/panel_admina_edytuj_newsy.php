		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div id="exampleZawartosc">
				<div class="panel panel-default">
					<div class="panel-heading"><h1><span class="glyphicon glyphicon-eye-open"></span> Panel admina - Edytuj news</h1></div>
					<div class="panel-body">
						...
						<?php echo form_open_multipart('','id="add_form"'); ?>
							...
							<?php 
								...
								echo form_textarea(
									array(
										'name'  => 'news_zawartosc',
										'id'    => 'news_zawartosc',
										'value' => $dane_newsa['news_zawartosc'],
										'class' => 'form-control'
									)
								); 
							?>
							...
							<div>
								<div class="obrazek">
									<img id="zdjecie" src="<?php echo $this->config->base_url(); ?>newsy/<?php echo $dane_newsa["news_plikGraficzny"]; ?>" alt="your image" />
								</div>
							</div>
							</div>
