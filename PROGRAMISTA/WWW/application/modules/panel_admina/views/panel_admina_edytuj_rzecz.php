		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div id="exampleZawartosc">
				<div class="panel panel-default">
					<div class="panel-heading"><h1><span class="glyphicon glyphicon-eye-open"></span> Panel admina - Edytuj przedmiot</h1></div>
					<div class="panel-body">
						...
						<?php echo form_open_multipart('','id="add_form"'); ?>
							...
							<?php 
								...
								echo form_input(
									array(
										'name'  => 'rzeczy_nazwa',
										'id'    => 'rzeczy_nazwa',
										'value' => $dane_rzeczy["rzeczy_nazwa"],
										'class' => 'form-control'
									)
								); 
							?>
							...
							<?php 
								...
								echo form_dropdown('rzeczy_kategoria_id',$rzeczy_kategorie_opcje,$dane_rzeczy["rzeczy_kategoria_id"],'class="form-control"'); 
							?>
							</div>
							<div class="form-group">
							<?php 
								echo form_label('Typ:', 'rzeczy_typy_id');
								echo form_dropdown('rzeczy_typy_id',$rzeczy_typy_opcje,$dane_rzeczy["rzeczy_typy_id"],'class="form-control"'); 
							?>
							</div>
							<div class="form-group">
							<?php 
							...
							<?php 
								...
								echo form_upload(
									array(
										...
										'value' => $dane_rzeczy["rzeczy_plikGraficzny"],
										'class' => ''
									)
								); 
							?>
							...
							<div>
								<div class="obrazek">
									<img id="zdjecie" src="<?php echo $this->config->base_url(); ?>przedmioty/<?php echo $dane_rzeczy["rzeczy_plikGraficzny"]; ?>" alt="your image" />
								</div>
							</div>
							</div>
